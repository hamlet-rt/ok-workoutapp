...
interface ConsumerStrategy {
    ...
    fun serialize(source: WrkContext): String
    fun deserialize(value: String, target: WrkContext)
}

class AppKafkaConsumer(
    private val config: AppKafkaConfig,
    consumerStrategies: List<ConsumerStrategy>,
    private val processor: WrkTngProcessor = WrkTngProcessor(),
    ...
    private fun sendResponse(context: WrkContext, strategy: ConsumerStrategy, outputTopic: String) {
